            ...
            >
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
                <div className="mb-12 lg:mb-0 text-center mx-auto">
                  <svg
                    className="w-8 h-8 text-gray-800 mb-6 mx-auto"
                  ...
                  <h6 className="font-medium">Indonesia</h6>
                </div>
                <div className="mb-12 lg:mb-0 text-center mx-auto">
                  <svg
                    className="w-8 h-8 text-gray-800 mb-6 mx-auto"
                  ...
                  <h6 className="font-medium">Palembang, 1516A</h6>
                </div>
                <div className="mb-6 md:mb-0 text-center mx-auto">
                  ...
                  <h6 className="font-medium">+62 82176457165</h6>
                </div>
