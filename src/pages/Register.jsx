...
const Register = () => {
  // input data register dan state nya
  ...
  const handleRegister = async (e) => {
    ...
    if (nama !== "" && email !== "" && password !== "") {
      ...
      try {
        await axios.post(
          `${process.env.REACT_APP_API_ADMIN}/auth/register`,
          data
        );
  ...
  return (
    <>
      <div>
        ...
        >
          <div
            className="bg-gray-800 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden bg-opacity-75"
            style={{ maxWidth: "1000px" }}
          >
            <div className="md:flex w-full">
              <div className="hidden md:block w-1/2 bg-grey-200 py-10 px-10">
                <svg
              ...
              <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
                <div className="text-center mb-10">
                  <h1 className="font-bold text-3xl text-gray-200">Sign Up</h1>
                  ...
                  <div>
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-5">
                        <label
                          htmlFor="name"
                          className="text-gray-100 text-xs font-semibold px-1"
                        >
                          User Name
                        </label>
                        <div className="flex">
                    ...
                    <div className="flex -mx-3">
                      <div className="w-full px-3 mb-5">
                        <button
                          type="submit"
                          className="block w-full max-w-xs mx-auto bg-gray-500 hover:bg-indigo-700 focus:bg-indigo-700 text-gray-100 rounded-lg px-3 py-3 font-semibold"
                        >
                          REGISTER NOW
                        </button>
                      </div>
